...
namespace HtmlAgilityPack
{
    ...
    public class MixedCodeDocument
    {
        ...
        {
            Load(new StreamReader(File.Open(path,FileMode.OpenOrCreate)));
        }
        ...
        {
            Load(new StreamReader(File.Open(path,FileMode.OpenOrCreate), detectEncodingFromByteOrderMarks));
        }
        ...
        {
            Load(new StreamReader(File.Open(path,FileMode.OpenOrCreate), encoding));
        }
        ...
        {
            Load(new StreamReader(File.Open(path,FileMode.OpenOrCreate), encoding, detectEncodingFromByteOrderMarks));
        }
        ...
        {
            Load(new StreamReader(File.Open(path,FileMode.OpenOrCreate), encoding, detectEncodingFromByteOrderMarks, buffersize));
        }
        ...
        {
            StreamWriter sw = new StreamWriter(File.Open(filename,FileMode.OpenOrCreate), GetOutEncoding());
            Save(sw);
        }
        ...
        {
            StreamWriter sw = new StreamWriter(File.Open(filename,FileMode.OpenOrCreate), encoding);
            Save(sw);
        }
